                ...
                <div class="container">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-4 col-md-7">
                            <div class="map__inner" style="height: 370px;">
                        ...
                        <div class="col-lg-4 col-md-7">
                            <div class="map__inner" style="height: 370px;">
                                <p style="color: red;">Foto profil diubah menjadi :</p>
                                <img id="gambar" style="width: 50%;">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <input type="file" name="foto[]" id="foto" multiple style="background: none; border: none;" />
                                </div>
                                <div class="col-lg-12">
