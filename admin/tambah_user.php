                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a>Tambah Data User</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="card-block">
                                                            <h4 class="sub-title">Input Data User</h4>
                                                            <form action="proses_tambah_user.php" method="POST"  enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="file" name="foto[]" class="form-control" placeholder="Foto Profil" required style="border: none;">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <textarea name="alamat" class="form-control" placeholder="Alamat" style="height: 150px; resize: none;"></textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
