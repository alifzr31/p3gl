...
<head>
    <title>Data User | Katalog Peta - BBSPGL </title>
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        <a class="mobile-menu" id="mobile-collapse" href="#!">
                            <i class="ti-menu" style="color: #282B30;"></i>
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <ul class="nav-right">
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="../user/file/profil/<?php echo $d['gambar']; ?>" class="img-radius" style="height: 50px; width: 50px; border-radius: 50%; content:icon;" alt="User-Profile-Image">
                                        ...
                                        <div class="row align-items-end">
                                            <div class="col-lg-8">
                                                <div class="page-header-title">
                                                    <div class="d-inline">
                                                        <h4>Data User</h4>
                                                        <span>Data akun pengguna yang terdaftar</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                   <ul class="breadcrumb-title">
                                                    ...
                                                    <li class="breadcrumb-item"><a>Data User</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><img src="../user/file/profil/<?php echo $d['gambar']; ?>" style="width: 100px;"></td>
                                                            ...
                                                            <td><?php echo $d['jk']; ?></td>
                                                            <td><?php echo $d['typeuser']; ?></td>
                                                            <td>
                                                                <a href="edit_user.php?nip=<?php echo $d['nip']; ?>" style="margin-right: 10px;"><i class="icofont icofont-edit" style="color: green;"></i></a>
                                                                <a href="hapus_user.php?nip=<?php echo $d['nip']; ?>" onclick="hapus()"><i class="icofont icofont-ui-delete" style="color: red;"></i></a>
                                                            </td>
                                                        </tr>
                                                        <?php
                                                            }
