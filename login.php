                ...
                <?php
                    if (isset($_GET['pesan'])) {
                        if ($_GET['pesan'] == "belum_login") {
                            echo "<div class='alert'>Anda harus login untuk mengakses halaman peta</div>";
                        }
                        if ($_GET['pesan'] == "gagal") {
                        ...
                        if ($_GET['pesan'] == "harus_login") {
                            echo "<div class='alert'>Anda belum login</div>";
                        }
                        if ($_GET['pesan'] == "daftar") {
                            echo "<div class='berhasil' style='margin-bottom: 15px;'>Registrasi berhasil</div>";
                        }
                        if ($_GET['pesan'] == "logout") {
                            echo "<div class='berhasil' style='margin-bottom: 15px;'>Anda berhasil logout</div>";
                        }
                    }
                ?>
            </div>
                        ...
                        <form action="proses_login.php" method="POST">
                            <div class="row" style="text-align: center;">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <br/>Belum punya akun? <a href="daftar.php" style="color: #f08632;">Daftar disini</a>
                                </div>
                            </div>
                        </form>
                    </div>
